...
class KoreanMiniGamesPage extends StatefulWidget {
  const KoreanMiniGamesPage({super.key});

  @override
  State<KoreanMiniGamesPage> createState() => _KoreanMiniGamesPageState();
}

class _KoreanMiniGamesPageState extends State<KoreanMiniGamesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBarWithBackArrowAndTitle(
        titleText: AppLocalizations.of(context)!.korean_quiz_games,
        onBackButtonPressed: () {
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Image.asset(
                                            "assets/images/mini_games_food_illustration_4.png",
                                            width: 100,
                                            height: 70,
                                            fit: BoxFit.cover,
                                          ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Image.asset(
                                            "assets/images/mini_games_places_illustration_4.png",
                                            width: 100,
                                            height: 70,
                                            fit: BoxFit.cover,
                                          ),

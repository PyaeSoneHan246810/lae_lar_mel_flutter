...
import 'mini_games_loading_page_orange.dart';
import 'mini_games_loading_page_yellow.dart';

class ChineseMiniGamesPage extends StatefulWidget {
  const ChineseMiniGamesPage({super.key});

  @override
  State<ChineseMiniGamesPage> createState() => _ChineseMiniGamesPageState();
}

class _ChineseMiniGamesPageState extends State<ChineseMiniGamesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBarWithBackArrowAndTitle(
        titleText: AppLocalizations.of(context)!.chinese_quiz_games,
        onBackButtonPressed: () {
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Image.asset(
                                            "assets/images/mini_games_food_illustration_2.png",
                                            width: 100,
                                            height: 70,
                                            fit: BoxFit.cover,
                                          ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Image.asset(
                                            "assets/images/mini_games_places_illustration_2.png",
                                            width: 100,
                                            height: 70,
                                            fit: BoxFit.cover,
                                          ),
